        ...
        <section className="toc-area w-full md:pt-[100px]">
            ...
            <section className="w-full min-h-screen px-3 md:px-8 py-12 md:py-24">
              <div id="sec-09" className="w-hull h-full p-[20px] md:p-[40px] bg-[rgba(255,255,255,1)] backdrop-blur-sm border-t border-l border-[rgba(255,255,255,0.2)] rounded-[10px] shadow-[20px_20px_50px_0_rgba(0,0,0,0.5)]">
                ...
                <hr className="border-b border-[#1a4776] mb-[20px] md:mb-[40px]" />
                <Image src={flowImage03} alt="アニメーションを実装する" className="w-full mx-auto mb-[40px] md:mb-[60px]" priority />
            ...
            <section className="w-full min-h-screen px-3 md:px-8 py-12 md:py-24">
              <div id="sec-10" className="w-hull h-full p-[20px] md:p-[40px] bg-[rgba(255,255,255,1)] backdrop-blur-sm border-t border-l border-[rgba(255,255,255,0.2)] rounded-[10px] shadow-[20px_20px_50px_0_rgba(0,0,0,0.5)]">
                <h2 id="anch-10" className='font-bold text-[24px] md:text-[50px] pt-[48px] md:pt-[96px] mt-[-48px] md:mt-[-96px]'>②左右に回転するアニメーションを実装する</h2>
                <hr className="border-b border-[#1a4776] mb-[20px] md:mb-[40px]" />
                <Image src={flowImage04} alt="アニメーションを実装する" className="w-full mx-auto mb-[40px] md:mb-[60px]" priority />
            ...
            <section className="w-full min-h-screen px-3 md:px-8 py-12 md:py-24">
              <div id="sec-11" className="w-hull h-full p-[20px] md:p-[40px] bg-[rgba(255,255,255,1)] backdrop-blur-sm border-t border-l border-[rgba(255,255,255,0.2)] rounded-[11px] shadow-[20px_20px_50px_0_rgba(0,0,0,0.5)]">
                <h2 id="anch-11" className='font-bold text-[24px] md:text-[50px] pt-[48px] md:pt-[96px] mt-[-48px] md:mt-[-96px]'>③左右に回転するアニメーションを実装する</h2>
                <hr className="border-b border-[#1a4776] mb-[20px] md:mb-[40px]" />
                <Image src={flowImage05} alt="アニメーションを実装する" className="w-full mx-auto mb-[40px] md:mb-[60px]" priority />
                <ol className="text-[16px] md:text-[30px] font-bold mb-[40px] md:mb-[60px]">
                  <li className="pl-[16px] md:pl-[30px] indent-[-16px] md:indent-[-30px] mb-[10px] md:mb-[20px]">
            ...
            <section className="w-full min-h-screen px-3 md:px-8 py-12 md:py-24">
              <div id="sec-12" className="w-hull h-full p-[20px] md:p-[40px] bg-[rgba(255,255,255,1)] backdrop-blur-sm border-t border-l border-[rgba(255,255,255,0.2)] rounded-[11px] shadow-[20px_20px_50px_0_rgba(0,0,0,0.5)]">
            ...
            <section className="w-full min-h-screen px-3 md:px-8 py-12 md:py-24">
              <div id="sec-13" className="w-hull h-full p-[20px] md:p-[40px] bg-[rgba(255,255,255,1)] backdrop-blur-sm border-t border-l border-[rgba(255,255,255,0.2)] rounded-[11px] shadow-[20px_20px_50px_0_rgba(0,0,0,0.5)]">
